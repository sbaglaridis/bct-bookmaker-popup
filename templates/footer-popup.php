...
if (!empty($bookmaker_id_for_popup)) :
    ...
    $popup_link = !empty(get_field('popup_link', $bookmaker_id_for_popup))
        ? get_field('popup_link', $bookmaker_id_for_popup)
        : $aff_link;
    $popup_bullets = !empty(get_field('popup_bullets', $bookmaker_id_for_popup))
        ? get_field('popup_bullets', $bookmaker_id_for_popup)
        : '';
